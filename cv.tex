...
\ind Mark Eli Kalderon. Unpublished manuscript. ``Experiential Pluralism and the Power of Perception.'' A discussion of the metaphysics of perceptual capacities. I argue that a pattern of dependence obtains between a perceptual capacity and its exercise that is inconsistent with experiential monsim, the doctrine that all sense experience has a single common nature. Written for a \href{Conference in Honour of Professor Charles Travis}.

\ind Mark Eli Kalderon. Unpublished manuscript. \emph{Form Without Matter: Empedocles and Aristotle on Color Perception}. The monograph is an essay in the philosophy of perception written in the medium of historiography. I argue that a puzzle in Empedocles (and one that persists to this day) motivates Aristotle's doctrine that sense perception receives the form without the matter of the perceived object. OUP currently has right of first refusal.
...
\ind Mark Eli Kalderon. Unpublished manuscript. ``Epistemic Responsibility.'' A critical discussion of Dowrkin's metaetchics. Written for a book symposium on Ronald Dworkin's \emph{Justice for Hedgehogs} to appear in \emph{Analysis Reviews}.

\ind Mark Eli Kalderon. Unpublished manuscript. ``The Philosophical Significance of the Frege-Geach Problem.'' The Frege-Geach problem is often presented as a narrow technical problem besetting expressivist semantics. I argue that this is a mistake, and that the problem is a deeper one concerning the nature of judgment. 

\ind Mark Eli Kalderon. Unpublished manuscript. ``Against Phenomenalism about Appearances.'' An argument for the objectivity of appearance.
...
\ind 2011. ``Before the Law'', Inagural Lecture, UCL, May.
...
\ind 2006--present. \emph{Excursus}, a blog on the technology of writing. Advocating the use of plain text over propriety binaries (such as Word documents) it presents a series of tutorials on how to adapt various tools for programmers to the task of academic writing.
